const questions = [
    {
        question: "Кто главный герой произведения?",
        answers: ["Дедушка", "Репка", "Жучка"],
        correctAnswer: "b"
    },
    {
        question: "Кто позвал кошку?",
        answers: ["Кошка", "Жучка", "Бабка"],
        correctAnswer: "b"
    },
    {
        question: "Кто пошёл рвать репку?",
        answers: ["Бабка", "Никто", "Дедушка"],
        correctAnswer: "c"
    }
];
