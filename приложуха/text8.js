const questions = [
    {
        question: "Что потерял юноша на фронте?",
        answers: ["Ничего", "Руку", "Ногу."],
        correctAnswer: "c"
    },
    {
        question: "Где юноша познакомился с Машей?",
        answers: ["В саду", "На набережной.", "В другом городе"],
        correctAnswer: "b"
    },
    {
        question: "Что молодой человек получает на фронте?",
        answers: ["Награду за храбрость и звание унтер-офицера.", "Орден I степени", "Орден Мужества"],
        correctAnswer: "a"
    }
];
