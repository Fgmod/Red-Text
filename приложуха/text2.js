const questions = [
    {
        question: "Главный герой в стихотворении М. Ю. Лермонтова «Бородино»?",
        answers: ["солдат-рассказчик", "народ", "полковник"],
        correctAnswer: "b"
    },
    {
        question: "Где находится Бородино?",
        answers: ["под Парижем", "под Москвой", "под Смоленском"],
        correctAnswer: "b"
    },
    {
        question: "Сколько по времени происходила перестрелка перед главным сражением?",
        answers: ["один день", "неделю", "два дня"],
        correctAnswer: "c"
    }
];
